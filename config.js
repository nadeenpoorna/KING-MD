...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("0715973437")
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? '[♕ɳศ∂εεɳ]' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'Bot' : process.env.PACK_NAME.split(";")[1],
  autoreaction:  process.env.AUTO_REACTION ||  'true' ,
  antibadword :  process.env.ANTI_BAD_WORD === undefined ? 'hutta,pakaya,kariya,fuck,sex,hukanna,porn' : process.env.ANTI_BAD_WORD,
